package com.example.onlineshop.ui.features.search.adapter
...
class SearchAdapter (
    ...
    ListAdapter<ProductItem, SearchAdapter.ViewHolder>(ShopCallBack()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(CategoryDetailsItemBinding.inflate(LayoutInflater.from(parent.context), parent, false))
