...
data class Product(
    val _links: com.example.onlineshop.data.network.model.dto.product.Links?,
    val attributes: List<com.example.onlineshop.data.network.model.dto.product.Attribute?>?,
    ...
    val categories: List<com.example.onlineshop.data.network.model.dto.product.Category?>?,
    ...
    val default_attributes: List<com.example.onlineshop.data.network.model.dto.product.DefaultAttribute?>?,
    val description: String?,
    val dimensions: com.example.onlineshop.data.network.model.dto.product.Dimensions?,
    ...
    val id: Int?,
    val images: List<com.example.onlineshop.data.network.model.dto.product.Image?>?,
